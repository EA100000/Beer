#!/usr/bin/env python3
"""
Analyse approfondie des 230,558 matchs pour améliorer les prédictions
...
print("🔍 ANALYSE APPROFONDIE DES DONNÉES RÉELLES")
print("=" * 80)
print()
...
# Filtrer les matchs avec données complètes
print("🧹 Filtrage des matchs avec données complètes...")
required_cols = ['HomeFouls', 'AwayFouls', 'HomeCorners', 'AwayCorners',
                 'HomeYellow', 'AwayYellow']

df_clean = df.dropna(subset=required_cols)
print(f"✅ {len(df_clean):,} matchs avec données complètes ({len(df_clean)/len(df)*100:.1f}%)")
print()
...
# ============================================================================
print("\n" + "=" * 80)
print("🔗 ANALYSE 2 : CORRÉLATIONS ENTRE VARIABLES")
print("=" * 80)
print()
...
print("📊 Corrélations importantes (|r| > 0.3) :")
print()
...
# ============================================================================
# ANALYSE 3 : PATTERNS DOMICILE/EXTÉRIEUR
# ============================================================================
print("\n" + "=" * 80)
print("🏠 ANALYSE 3 : AVANTAGE DOMICILE/EXTÉRIEUR")
print("=" * 80)
print()
...
for market, home_col, away_col in [('Fautes', 'HomeFouls', 'AwayFouls'),
    ...
    print(f"  Extérieur : {away_mean:.2f} en moyenne")
...
# ============================================================================
# ANALYSE 4 : VARIANCE ET STABILITÉ
# ============================================================================
print("\n" + "=" * 80)
print("📈 ANALYSE 4 : VARIANCE ET STABILITÉ (COEFFICIENT DE VARIATION)")
print("=" * 80)
print()
...
for market, col in [('Fautes', 'TotalFouls'),
    ...
    print(f"  Stabilité      : {'TRÈS STABLE' if cv < 20 else 'STABLE' if cv < 30 else 'VOLATILE'}")

    variance_dict[market] = {
        'mean': round(mean, 2),
        'std': round(std, 2),
        'cv': round(cv, 2),
        'stability': 'TRÈS STABLE' if cv < 20 else 'STABLE' if cv < 30 else 'VOLATILE'
    }
...
# ============================================================================
print("\n" + "=" * 80)
print("🎯 ANALYSE 5 : MEILLEURS SEUILS POUR MAXIMISER LE WIN RATE")
print("=" * 80)
print()
...
for market, col in [('Fautes', 'TotalFouls'),
    ...
    # On cherche les seuils où la distance à la moyenne est maximale
    ...
    for threshold in test_thresholds:
        ...
        # Meilleurs seuils = ceux où le win rate est le plus éloigné de 50%
...
print("✅ Résultats sauvegardés dans : real_data_analysis.json")
print()
...
# ============================================================================
print("=" * 80)
print("🎯 RECOMMANDATIONS POUR AMÉLIORER LES ALGORITHMES")
print("=" * 80)
print()
...
print("1️⃣ COEFFICIENTS DE VARIATION (à utiliser dans enhancedOverUnder.ts) :")
...
print("2️⃣ AJUSTEMENTS DOMICILE/EXTÉRIEUR (à utiliser) :")
print(f"   Fautes : Domicile {fautes_home_boost:+.1%}, Extérieur {-fautes_home_boost:+.1%}")
print(f"   Corners : Domicile {corners_home_boost:+.1%}, Extérieur {-corners_home_boost:+.1%}")
print()

print("3️⃣ SEUILS OPTIMAUX (meilleur win rate) :")
...
print("✅ Recommandations sauvegardées dans : recommendations.json")
print()
...
print("   - real_data_analysis.json : Statistiques détaillées")
print("   - recommendations.json : Recommandations d'amélioration")
print()
print("🚀 Prochaine étape : Intégrer ces insights dans enhancedOverUnder.ts")
